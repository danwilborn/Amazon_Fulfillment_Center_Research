...
counties_df = pd.read_csv('../data/csv/adjacent_counties_5%.csv')
non_adj_counties_df = pd.read_csv('../data/csv/non_adjacent_counties_5%.csv')
CPI_df = pd.read_csv('../data/csv/CPI_base_year_2000.csv')

with open('../data/csv/year_and_county_data_5%.csv','w') as out_file:
